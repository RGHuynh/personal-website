...
export default function Project({title, image, subTitle, body, backgroundStyle, titleColor}) {
    return(
        <div className="project-container" style={ backgroundStyle }>
            ...
            <a href="https://www.trustroots.org/" className="btn btn__position btn__size btn__color">
                View
            </a>
